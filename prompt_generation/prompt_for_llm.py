prompt = '''You are given two inputs:
      ...
      3. Based on the domain and classname, produce four lists in **valid JSON** format (no extra text or explanation, just valid JSON):
        - "action_or_pose": 5 possible actions or poses
        ...
        - "invariant_features": 5 short, **unique** fine-grained features that belong to this classname and **MUST** not be found in other classes
          • Keep each feature concise (e.g., "striped fur", "spiral shell", "red tail light").
        - "cooccurrence": 5 objects or entities that commonly appear with or near this classname, within the given domain context.
        - "background": 5 background settings typically associated with this classname.
